...
async def main():
    ...
    print(f"    python integrations/graphiti/test_graphiti_memory.py")
    print()
    print(f"    # Test just Ollama embeddings:")
    print(f"    python integrations/graphiti/test_graphiti_memory.py --test ollama")
    print()
    print(f"    # Test with production database:")
    print(f"    python integrations/graphiti/test_graphiti_memory.py --database auto_claude_memory")
    print()
